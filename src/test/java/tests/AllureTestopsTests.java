...
public class AllureTestopsTests {
    ...
    void viewTestCaseWithApiTest() {
        /*
        1. Make GET request.ftl to /api/rs/testcase/13328/overview
    ...
    void createTestCaseWithApiTest() {
        /*
        1. Make POST request.ftl to /api/rs/testcasetree/leaf?projectId=1722
                with body {"name":"Some random test"}
        2. Get test case {id} from response.ftl {"id":13330,"name":"Some random test","automated":false,"external":false,"createdDate":1669920611154,"statusName":"Draft","statusColor":"#abb8c3"}
...
//                .post("/api/rs/testcasetree/leaf?projectId=1722")
        ...
        String steps = {"steps": [{"name": "Первый шаг", "steps": [], "leaf": true,
                "stepsCount": 0,
                "hasContent": false
        }
  ]
